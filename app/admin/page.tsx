  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto p-1 md:p-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-amber-200 pb-5">
        <div>
          <h1 className="text-3xl font-black text-amber-900 tracking-tight">Selamat Datang di Admin Panel 👋</h1>
          <p className="text-sm text-amber-700 mt-1">Kelola penjualan, validasi pembayaran, dan pantau dapur secara real-time.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, index) => (
          <div 
            key={index} 
            className={`bg-gradient-to-br ${stat.color} rounded-2xl p-6 shadow-lg border border-white/10 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 relative overflow-hidden group`}
          >
            ...
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <p className="text-4xl font-black mt-2 leading-none">{stat.value}</p>
              </div>
              <span className="text-3xl p-2 bg-white/10 rounded-xl backdrop-blur-md">{stat.icon}</span>
            </div>
            <Link 
              href={stat.link} 
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link 
              ...
              className="bg-white rounded-xl p-5 border-2 border-amber-200 shadow-sm hover:shadow-md transition-all hover:border-amber-400 group active:scale-[0.99] flex items-center gap-4"
            >
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-amber-700">
                  {pendingCount > 0 
                    ? `${pendingCount} pesanan menunggu validasi pembayaran` 
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-amber-700">
                  {processingCount > 0 
                    ? `${processingCount} pesanan sedang diproses di dapur` 
                    : "Dapur sedang kosong"}
                </p>
              </div>
            </Link>

...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-amber-50/20 text-gray-800 selection:bg-amber-800 selection:text-white">
      ...
      {/* Hero Section */}
      <section className="relative py-14 md:py-20 bg-amber-950 bg-cover bg-center overflow-hidden text-center text-white" style={{ backgroundImage: "url('/images/cafe_hero_image.png')" }}>
        ...
        <div className="relative max-w-4xl mx-auto px-4 space-y-4 z-10">
          ...
          <p className="text-amber-100/90 text-sm md:text-lg italic font-medium max-w-xl mx-auto leading-relaxed">"Ruang ketiga yang nyaman dengan seduhan kopi berkualitas terbaik untuk produktivitas Anda"</p>
        </div>
      </section>
      ...
      <section className="px-4 py-12 md:py-16">
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="bg-white rounded-3xl shadow-xl shadow-amber-900/5 p-6 md:p-10 border border-amber-100/50">
            <span className="text-[10px] font-bold text-amber-800 bg-amber-50 border border-amber-100 px-3 py-1 rounded-full uppercase tracking-wider select-none">Profil Kami</span>
            <h2 className="text-2xl md:text-3xl font-extrabold text-amber-900 mt-4 mb-4">Tentang Laa Coffee</h2>
            <p className="text-gray-600 leading-relaxed text-sm md:text-base">{LAA_COFFEE_INFO.description}</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-8">
              <Facilities atmosphere={LAA_COFFEE_INFO.atmosphere} amenities={LAA_COFFEE_INFO.amenities} />
            </div>

            {/* Column 2: Location details & Operating Hours */}
            <div className="space-y-8">
              <LocationInfo address={LAA_COFFEE_INFO.address} phone={LAA_COFFEE_INFO.phone} operatingHours={LAA_COFFEE_INFO.operatingHours} />
            </div>
          </div>
          ...
          <div className="bg-amber-50/50 rounded-3xl p-6 md:p-8 border border-amber-100/70 shadow-sm max-w-4xl mx-auto">
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs md:text-sm text-gray-600 leading-relaxed">{LAA_COFFEE_INFO.visitTips}</p>
                <p className="text-[10px] text-gray-400 mt-3 italic">* Catatan: Informasi operasional di atas dapat berubah sewaktu-waktu. Hubungi WhatsApp resmi kami untuk info reservasi tempat.</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="max-w-3xl mx-auto rounded-3xl overflow-hidden shadow-xl shadow-amber-900/5 border border-amber-100/50 bg-white">
              <div className="relative w-full h-72 md:h-96">
                <iframe width="100%" height="100%" style={{ border: 0 }} loading="lazy" allowFullScreen referrerPolicy="no-referrer-when-downgrade" src={MAPS_EMBED_URL} className="w-full h-full" />
              </div>
          ...
          <div className="text-center bg-gradient-to-r from-amber-950 to-amber-900 text-white rounded-3xl p-8 md:p-12 shadow-xl shadow-amber-950/20 border border-amber-850/20 space-y-6 max-w-4xl mx-auto relative overflow-hidden">
            ...
            <h3 className="text-xl md:text-2xl font-extrabold tracking-tight">Sudah Menemukan Tempat Duduk yang Nyaman?</h3>
        ...
        <div className="max-w-6xl mx-auto space-y-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-amber-200/70 leading-relaxed max-w-sm">Tempat ternyaman untuk produktivitas Anda di Mojokerto dengan sajian seduhan berkualitas dan harga terjangkau.</p>
            </div>
